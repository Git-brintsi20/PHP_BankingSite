...
$query = "SELECT borrower.customer_name , borrower.loan_number , loan.amount FROM borrower join loan ON borrower.loan_number=loan.loan_number;";
...
<body>
    <header class="header">
        <h1 style="font-size: 50px;">Borrower Details</h1>
    </header>
